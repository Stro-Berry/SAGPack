...
//LUMIUM
	...
	//Lumium block
	event.replaceOutput({}, 'silents_mechanisms:lumium_block', 'thermal:lumium_block')
	event.replaceOutput({}, 'emendatusenigmatica:lumium_block', 'thermal:lumium_block')
...
//SIGNALUM
	...
	//Signalum block
	event.replaceOutput({}, 'silents_mechanisms:signalum_block', 'thermal:signalum_block')
	event.replaceOutput({}, 'emendatusenigmatica:signalum_block', 'thermal:signalum_block')
...
//ENDERIUM
	...
	//Enderium block
	event.replaceOutput({}, 'silents_mechanisms:enderium_block', 'thermal:enderium_block')
	event.replaceOutput({}, 'emendatusenigmatica:enderium_block', 'thermal:enderium_block')
